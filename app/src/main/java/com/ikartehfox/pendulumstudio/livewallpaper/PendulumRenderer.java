...
import com.ikartehfox.pendulumstudio.doublependulum.DoublePendulum;
import com.ikartehfox.pendulumstudio.doublesphericalpendulum.DoubleSphericalPendulum;
import com.ikartehfox.pendulumstudio.mathematicalpendulum.MathematicalPendulum;
import com.ikartehfox.pendulumstudio.pendulumwave.PendulumWave;
import com.ikartehfox.pendulumstudio.sphericalpendulum.SphericalPendulum;
import com.ikartehfox.pendulumstudio.springmathematicalpendulum.SpringMathematicalPendulum;
import com.ikartehfox.pendulumstudio.springpendulum2d.SpringPendulum2D;
import com.ikartehfox.pendulumstudio.springpendulum3d.SpringPendulum3D;
import com.ikartehfox.pendulumstudio.springsphericalpendulum.SpringSphericalPendulum;
...
public class PendulumRenderer implements GLSurfaceView.Renderer {
    ...
    public static final DoublePendulum mPendulumDP = new DoublePendulum(75., 75., 1., 1., 45. * Math.PI / 180.,
            5. * Math.PI / 8., 0. * Math.PI / 180.,
            45. * Math.PI / 180., 9.81 * 100., 0. / 1.e6, true, 100, true);
    public static final DoubleSphericalPendulum mPendulumDSP = new DoubleSphericalPendulum(75., 75., 1., 1., 45. * Math.PI / 180., 90. * Math.PI / 180.,
            5. * Math.PI / 8., 90. * Math.PI / 180., 0. * Math.PI / 180.,
            0. * Math.PI / 180., 45. * Math.PI / 180., 45. * Math.PI / 180., 9.81 * 100., 0. / 1.e6, true, 100, true);
    public static final MathematicalPendulum mPendulumMP = new MathematicalPendulum(100., 1., 90. * Math.PI / 180.,
            0. * Math.PI / 180., 9.81 * 100., 0. / 1.e6, true, 3000, true);
    public static final SphericalPendulum mPendulumSP = new SphericalPendulum(100., 1., 45. * Math.PI / 180., 90. * Math.PI / 180.,
            0. * Math.PI / 180., 0. * Math.PI / 180., 9.81 * 100., 0. / 1.e6, true, 3000, true);
    public static final SpringMathematicalPendulum mPendulumSMP = new SpringMathematicalPendulum
            (75., 50., 75., 1., 1., 75., 0.,
                    45. * Math.PI / 180.,
                    5. * Math.PI / 8.,
                    0. * Math.PI / 180.,
                    45. * Math.PI / 180., 9.81 * 100., 0. / 1.e6, true, 100, true);
    public static final SpringPendulum2D mPendulumSP2D = new SpringPendulum2D
            (75., 50., 1.,
                    75., 0.,
                    75., 0.,
                    9.81 * 100., 0. / 1.e6, true, 100, true);
    public static final SpringPendulum3D mPendulumSP3D = new SpringPendulum3D
            (75., 50., 1.,
                    75., 0.,
                    75., 0.,
                    75., 0.,
                    9.81 * 100., 0. / 1.e6, true, 100, true);
    public static final SpringSphericalPendulum mPendulumSSP = new SpringSphericalPendulum
            (75., 75., 1., 1., 50., 0., 0., 75.,
                    45. * Math.PI / 180., 90. * Math.PI / 180.,
                    0., 0., 0.,
                    0. * Math.PI / 180.,
                    0. * Math.PI / 180., 9.81 * 100., 0. / 1.e6, true, 100, true);
    public static final PendulumWave mPendulumPW = new PendulumWave
    ...
    public void switchPendulum(String pendulum, boolean damping, boolean trace) {
        switch (pendulum) {
            case "0":
                this.mPendulum = mPendulumMP;
                break;
            case "1":
                this.mPendulum = mPendulumSP;
                break;
            case "2":
                this.mPendulum = mPendulumSP2D;
                break;
            case "3":
                this.mPendulum = mPendulumSP3D;
                break;
            case "4":
                this.mPendulum = mPendulumDP;
                break;
            case "5":
                this.mPendulum = mPendulumDSP;
                break;
            case "6":
                this.mPendulum = mPendulumSMP;
                break;
            case "7":
                this.mPendulum = mPendulumSSP;
                break;
            default:
                this.mPendulum = mPendulumPW;
                break;
        }
