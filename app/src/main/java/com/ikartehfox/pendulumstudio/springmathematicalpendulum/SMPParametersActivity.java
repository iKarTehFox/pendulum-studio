...
public class SMPParametersActivity extends Activity {
    ...
    public void readParameters() {
        EditText editparam = findViewById(R.id.SMP_editaa);
        ...
        editparam = findViewById(R.id.SMP_editl);
        ...
        editparam = findViewById(R.id.SMP_editm);
        ...
        editparam = findViewById(R.id.SMP_editm2);
        ...
        editparam = findViewById(R.id.SMP_editg);
        ...
        editparam = findViewById(R.id.SMP_editthv0);
        ...
        editparam = findViewById(R.id.SMP_editth2);
    ...
    public void okButton(View v) {
        ...
        if (!editparam.getText().toString().isEmpty() && Float.parseFloat(editparam.getText().toString()) > 0.)
            SMPSimulationParameters.simParams.aa = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SMP_editl);
        if (!editparam.getText().toString().isEmpty() && Float.parseFloat(editparam.getText().toString()) > 0.)
            SMPSimulationParameters.simParams.l = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SMP_editm);
        if (!editparam.getText().toString().isEmpty() && Float.parseFloat(editparam.getText().toString()) > 0.)
            SMPSimulationParameters.simParams.m1 = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SMP_editm2);
        if (!editparam.getText().toString().isEmpty() && Float.parseFloat(editparam.getText().toString()) > 0.)
            SMPSimulationParameters.simParams.m2 = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SMP_editg);
        if (!editparam.getText().toString().isEmpty())
            SMPSimulationParameters.simParams.g = Float.parseFloat(editparam.getText().toString()) * 100.f;
        editparam = findViewById(R.id.SMP_editk);
        if (!editparam.getText().toString().isEmpty())
            SMPSimulationParameters.simParams.k = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SMP_editgam);
        if (!editparam.getText().toString().isEmpty())
            SMPSimulationParameters.simParams.gam = Float.parseFloat(editparam.getText().toString()) / 1.e3f;
        ...
        editparam = findViewById(R.id.SMP_edits);
        if (!editparam.getText().toString().isEmpty())
            SMPSimulationParameters.simParams.s = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SMP_editsv);
        if (!editparam.getText().toString().isEmpty())
            SMPSimulationParameters.simParams.sv = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SMP_editth0);
        if (!editparam.getText().toString().isEmpty())
            SMPSimulationParameters.simParams.th1 = (float) (Float.parseFloat(editparam.getText().toString()) *
                    Math.PI / 180.f);
        editparam = findViewById(R.id.SMP_editthv0);
        if (!editparam.getText().toString().isEmpty())
            SMPSimulationParameters.simParams.thv1 = (float) (Float.parseFloat(editparam.getText().toString()) *
                    Math.PI / 180.f);

        editparam = findViewById(R.id.SMP_editth2);
        if (!editparam.getText().toString().isEmpty())
            SMPSimulationParameters.simParams.th2 = (float) (Float.parseFloat(editparam.getText().toString()) *
                    Math.PI / 180.f);
        editparam = findViewById(R.id.SMP_editthv2);
        if (!editparam.getText().toString().isEmpty())
            SMPSimulationParameters.simParams.thv2 = (float) (Float.parseFloat(editparam.getText().toString()) *
                    Math.PI / 180.f);
    ...
    public void PendulumColor2(View v) {
        ...
        colorDialog.setButton(DialogInterface.BUTTON_POSITIVE, getString(android.R.string.ok), (dialog, which) -> {
            ...
            Button PColor = findViewById(R.id.SMP_PendulumColor2);
