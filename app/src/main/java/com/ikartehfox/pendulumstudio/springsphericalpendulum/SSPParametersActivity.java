...
public class SSPParametersActivity extends Activity {
    ...
    public void readParameters() {
        EditText editparam = findViewById(R.id.SSP_edita);
        ...
        editparam = findViewById(R.id.SSP_editl);
        ...
        editparam = findViewById(R.id.SSP_editm);
        ...
        editparam = findViewById(R.id.SSP_editm2);
        ...
        editparam = findViewById(R.id.SSP_editg);
        ...
        editparam = findViewById(R.id.SSP_editthv0);
        ...
        editparam = findViewById(R.id.SSP_editph0);
    ...
    public void okButton(View v) {
        ...
        if (!editparam.getText().toString().isEmpty() && Float.parseFloat(editparam.getText().toString()) > 0.)
            SSPSimulationParameters.simParams.aa = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SSP_editl);
        if (!editparam.getText().toString().isEmpty() && Float.parseFloat(editparam.getText().toString()) > 0.)
            SSPSimulationParameters.simParams.l = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SSP_editm);
        if (!editparam.getText().toString().isEmpty() && Float.parseFloat(editparam.getText().toString()) > 0.)
            SSPSimulationParameters.simParams.m1 = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SSP_editm2);
        if (!editparam.getText().toString().isEmpty() && Float.parseFloat(editparam.getText().toString()) > 0.)
            SSPSimulationParameters.simParams.m2 = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SSP_editg);
        if (!editparam.getText().toString().isEmpty())
            SSPSimulationParameters.simParams.g = Float.parseFloat(editparam.getText().toString()) * 100.f;
        editparam = findViewById(R.id.SSP_editk);
        if (!editparam.getText().toString().isEmpty())
            SSPSimulationParameters.simParams.k = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SSP_editgam);
        if (!editparam.getText().toString().isEmpty())
            SSPSimulationParameters.simParams.gam = Float.parseFloat(editparam.getText().toString()) / 1.e3f;
        ...
        editparam = findViewById(R.id.SSP_editx0);
        if (!editparam.getText().toString().isEmpty())
            SSPSimulationParameters.simParams.x = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SSP_editxv0);
        if (!editparam.getText().toString().isEmpty())
            SSPSimulationParameters.simParams.xv = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SSP_edity0);
        if (!editparam.getText().toString().isEmpty())
            SSPSimulationParameters.simParams.y = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SSP_edityv0);
        if (!editparam.getText().toString().isEmpty())
            SSPSimulationParameters.simParams.yv = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SSP_editz0);
        if (!editparam.getText().toString().isEmpty())
            SSPSimulationParameters.simParams.z = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.SSP_editzv0);
        if (!editparam.getText().toString().isEmpty())
            SSPSimulationParameters.simParams.zv = Float.parseFloat(editparam.getText().toString());

        editparam = findViewById(R.id.SSP_editth0);
        if (!editparam.getText().toString().isEmpty())
            SSPSimulationParameters.simParams.th1 = (float) (Float.parseFloat(editparam.getText().toString()) *
                    Math.PI / 180.f);
        editparam = findViewById(R.id.SSP_editthv0);
        if (!editparam.getText().toString().isEmpty())
            SSPSimulationParameters.simParams.thv1 = (float) (Float.parseFloat(editparam.getText().toString()) *
                    Math.PI / 180.f);
        editparam = findViewById(R.id.SSP_editph0);
        if (!editparam.getText().toString().isEmpty())
            SSPSimulationParameters.simParams.ph1 = (float) (Float.parseFloat(editparam.getText().toString()) *
                    Math.PI / 180.f);
        editparam = findViewById(R.id.SSP_editphv0);
        if (!editparam.getText().toString().isEmpty())
            SSPSimulationParameters.simParams.phv1 = (float) (Float.parseFloat(editparam.getText().toString()) *
                    Math.PI / 180.f);
    ...
    public void PendulumColor2(View v) {
        ...
        colorDialog.setButton(DialogInterface.BUTTON_POSITIVE, getString(android.R.string.ok), (dialog, which) -> {
            ...
            Button PColor = findViewById(R.id.SSP_PendulumColor2);
