...
public abstract class MechSystemrkf45 {
    ...
    protected final double a4;
    protected final double a5;
    protected final double a6;
    protected final double b2;
    protected final double b3;
    protected final double b4;
    protected final double b5;
    ...
    protected final double d4;
    protected final double d5;
    protected final double d6;
    protected final double e5;
    protected final double e6;
    protected final double f6;
    protected final double r1;
    protected final double r3;
    protected final double r4;
    protected final double r5;
    protected final double r6;
    protected final double n1;
    protected final double n3;
    protected final double n4;
    protected final double n5;
