package com.ikartehfox.pendulumstudio.doublesphericalpendulum;
...
public class DSPParametersActivity extends Activity {
    ...
    public void readParameters() {
        EditText editparam = findViewById(R.id.DSP_editl);
        ...
        editparam = findViewById(R.id.DSP_editl2);
        ...
        editparam = findViewById(R.id.DSP_editm);
        ...
        editparam = findViewById(R.id.DSP_editm2);
        ...
        editparam = findViewById(R.id.DSP_editthv0);
        ...
        editparam = findViewById(R.id.DSP_editph0);
        ...
        editparam = findViewById(R.id.DSP_editphv0);
        ...
        editparam = findViewById(R.id.DSP_editth2);
        ...
        editparam = findViewById(R.id.DSP_editthv2);
        ...
        editparam = findViewById(R.id.DSP_editph2);
    ...
    public void okButton(View v) {
        ...
        if (!editparam.getText().toString().isEmpty() && Float.parseFloat(editparam.getText().toString()) > 0.)
            DSPSimulationParameters.simParams.l1 = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.DSP_editl2);
        if (!editparam.getText().toString().isEmpty() && Float.parseFloat(editparam.getText().toString()) > 0.)
            DSPSimulationParameters.simParams.l2 = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.DSP_editm);
        if (!editparam.getText().toString().isEmpty() && Float.parseFloat(editparam.getText().toString()) > 0.)
            DSPSimulationParameters.simParams.m1 = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.DSP_editm2);
        if (!editparam.getText().toString().isEmpty() && Float.parseFloat(editparam.getText().toString()) > 0.)
            DSPSimulationParameters.simParams.m2 = Float.parseFloat(editparam.getText().toString());
        editparam = findViewById(R.id.DSP_editg);
        if (!editparam.getText().toString().isEmpty())
            DSPSimulationParameters.simParams.g = Float.parseFloat(editparam.getText().toString()) * 100.f;
        editparam = findViewById(R.id.DSP_editk);
        if (!editparam.getText().toString().isEmpty())
            DSPSimulationParameters.simParams.k = Float.parseFloat(editparam.getText().toString()) / 1.e3f;
        ...
        editparam = findViewById(R.id.DSP_editth0);
        if (!editparam.getText().toString().isEmpty())
            DSPSimulationParameters.simParams.th1 = (float) (Float.parseFloat(editparam.getText().toString()) *
                    Math.PI / 180.f);
        editparam = findViewById(R.id.DSP_editthv0);
        if (!editparam.getText().toString().isEmpty())
            DSPSimulationParameters.simParams.thv1 = (float) (Float.parseFloat(editparam.getText().toString()) *
                    Math.PI / 180.f);
        editparam = findViewById(R.id.DSP_editph0);
        if (!editparam.getText().toString().isEmpty())
            DSPSimulationParameters.simParams.ph1 = (float) (Float.parseFloat(editparam.getText().toString()) *
                    Math.PI / 180.f);
        editparam = findViewById(R.id.DSP_editphv0);
        if (!editparam.getText().toString().isEmpty())
            DSPSimulationParameters.simParams.phv1 = (float) (Float.parseFloat(editparam.getText().toString()) *
                    Math.PI / 180.f);

        editparam = findViewById(R.id.DSP_editth2);
        if (!editparam.getText().toString().isEmpty())
            DSPSimulationParameters.simParams.th2 = (float) (Float.parseFloat(editparam.getText().toString()) *
                    Math.PI / 180.f);
        editparam = findViewById(R.id.DSP_editthv2);
        if (!editparam.getText().toString().isEmpty())
            DSPSimulationParameters.simParams.thv2 = (float) (Float.parseFloat(editparam.getText().toString()) *
                    Math.PI / 180.f);
        editparam = findViewById(R.id.DSP_editph2);
        if (!editparam.getText().toString().isEmpty())
            DSPSimulationParameters.simParams.ph2 = (float) (Float.parseFloat(editparam.getText().toString()) *
                    Math.PI / 180.f);
        editparam = findViewById(R.id.DSP_editphv2);
        if (!editparam.getText().toString().isEmpty())
            DSPSimulationParameters.simParams.phv2 = (float) (Float.parseFloat(editparam.getText().toString()) *
                    Math.PI / 180.f);
    ...
    public void PendulumColor2(View v) {
        ...
        colorDialog.setButton(DialogInterface.BUTTON_POSITIVE, getString(android.R.string.ok), (dialog, which) -> {
            ...
            Button PColor = findViewById(R.id.DSP_PendulumColor2);
